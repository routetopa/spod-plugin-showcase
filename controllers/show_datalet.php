...
class SPODSHOWCASE_CTRL_ShowDatalet extends OW_ActionController
{
    public function index(array $params)
    {
        ...
        if(!empty($datalet))
        {
            ...
            $this->assign('static_image_url', OW::getPluginManager()->getPlugin('ode')->getStaticUrl() . 'images/datalet/datalet_' . $datalet_id . '.png');
            ...
            $this->assign('twitter_image', OW::getPluginManager()->getPlugin('ode')->getStaticUrl() . 'images/datalet/datalet_' . $datalet_id . '.png');
